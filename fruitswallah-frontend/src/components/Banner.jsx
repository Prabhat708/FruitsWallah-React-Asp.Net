          ...
          <div className="row g-4 align-items-center">
            <div className="col-lg-6">
              <div className="">
                ...
                <Link
                  to="#"
                  className="banner-btn btn border-2 border-warning rounded-pill text-dark py-3 px-5"
                >
                  BUY
                </Link>
              </div>
            ...
            <div className="col-lg-6">
              <div className="position-relative">
                ...
                <div
                  className="d-flex align-items-center justify-content-center bg-white rounded-circle position-absolute top-0 mt-5 me-5 end-0"
                  style={{
                    width: "95px",
                    height: "95px",
                ...
                >
                  <div className="d-flex flex-column">
                    <span className="h2 mb-0">150 </span>
